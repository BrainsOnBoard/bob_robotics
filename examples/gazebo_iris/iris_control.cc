...
void ArduCopterPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  // iteration.
  this->dataPtr->updateConnection = event::Events::ConnectWorldUpdateBegin(std::bind(&ArduCopterPlugin::OnUpdate, this));

  std::cout << "ArduCopter ready to fly. The force will be with you" << std::endl;
