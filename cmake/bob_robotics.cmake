...
macro(BoB_project)
    ...
    if(WIN32)
        set(root "$ENV{VCPKG_ROOT}/installed/${CMAKE_GENERATOR_PLATFORM}-windows")
        if(${CMAKE_BUILD_TYPE} STREQUAL Debug)
            set(root "${root}/debug")
        endif()
        file(GLOB dll_files "${root}/bin/*.dll")
        file(GLOB lib_files "${root}/lib/*.lib")
        set(files "${dll_files};${lib_files}")
...
if(NOT DEFINED BOB_DIR)
    if(WIN32)
        set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${BOB_ROBOTICS_PATH}/bin/${CMAKE_BUILD_TYPE})
        set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_DEBUG ${BOB_ROBOTICS_PATH}/bin/Debug)
        set(CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELEASE ${BOB_ROBOTICS_PATH}/bin/Release)
    else()
