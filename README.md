[![Build Status](https://gen-ci.inf.sussex.ac.uk/buildStatus/icon?job=BoB robotics/bob_robotics/master)](https://gen-ci.inf.sussex.ac.uk/job/BoB%20robotics/job/bob_robotics/job/master/)
# BoB robotics
