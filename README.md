[![Build Status](https://gen-ci.inf.sussex.ac.uk/buildStatus/icon?job=BoB%20robotics/bob_robotics/jenkins/master)](https://gen-ci.inf.sussex.ac.uk/job/BoB%20robotics/bob_robotics/jenkins/master)
# BoB robotics
